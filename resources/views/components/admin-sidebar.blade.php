      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ set_active(['kelas.index', 'spp.index']) }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ set_active(['spp.index']) }}"><a class="nav-link" href="">SPP</a></li>
            </ul>
          </li>
          <li class="menu-header">Pembayaran</li>
          <li class="nav-item {{ set_active(['transaksi.index', 'transaksi.create', 'transaksi.edit']) }}">
            <a href="#" class="nav-link"><i class="fas fa-fire"></i><span>Transaksi Pembayaran</span></a>
          </li>
          <li class="nav-item {{ set_active(['history.index']) }}">
            <a href="#" class="nav-link"><i class="fas fa-fire"></i><span>History Pembayaran</span></a>
          </li>
          <li class="nav-item {{ set_active(['laporan.index']) }}">
            <a href="#" class="nav-link"><i class="fas fa-fire"></i><span>Laporan Pembayaran</span></a>
          </li>
        </ul>
    </aside>
  </div>
